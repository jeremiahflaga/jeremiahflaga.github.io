<div class="">
    <div class="float-right">
        <span class="text-primary experience-date">December 2012 - May 2016
    </span></div>
    <div class="">
                ...
                <div class="pr-3">
                    <ol>
                        <li> 
                            ...
                            <p>
                                This is when I <em>started</em> to understand the Dependency Inversion Principle, the use of the Factory design pattern, and other things.
                            </p>
                        </li>
                        <li> 
                            <p>
                        ...
                        <li>
                            <p>
                                This is the time when I, and my teammates, plunged into the Clean Code book because one of our team leads made us read one chapter of the book each week, and spend about an hour each week discussing that chapter.
                            </p>
                            <p>
